...
Generate each image separately. Replace the variables from the article; never tile several images into one.
...
Structure type:
{Workflow / System fragment / Before-after / Character state / Concept metaphor / Layered method / Map-route / Mini comic}

Core idea:
{the one idea this image expresses}

Composition:
{the concrete scene: where Xiaohei is, what it's doing, the main objects, how information flows}
