...
function usage() {
  console.log(`Install the ssd skill.

Usage:
  npx --yes github:pde201/ssd [codex|claude] [--force]
  npx --yes github:pde201/ssd --dest /path/to/skills-dir [--force]
...
Run with --force to replace it:
  npx --yes github:pde201/ssd ${options.target} --force`);
    process.exit(1);
  }
